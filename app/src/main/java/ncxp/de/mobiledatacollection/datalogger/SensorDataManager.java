...
import ncxp.de.mobiledatacollection.datalogger.data.Data;
...
public class SensorDataManager {
	...
	public SensorEventListener getSensorEventListener(int sensorType) {
		SensorEventListener sensorEventListener = sensorEventListeners.computeIfAbsent(sensorType, this::createSensorEventListener);
	...
	public List<DeviceSensor> getAvailableDeviceSensors() {
		List<Sensor> sensors = sensorManager.getSensorList(Sensor.TYPE_ALL);
		List<DeviceSensor> availableDeviceSensors = new ArrayList<>();
		sensors.forEach(sensor -> {
			DeviceSensor availableDeviceSensor = new DeviceSensor(sensor);
